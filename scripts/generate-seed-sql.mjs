// Generates supabase/01-seed-places.sql from the OpenStreetMap snapshot,
...
await writeFile(
  new URL("../supabase/01-seed-places.sql", import.meta.url),
  sql
);

console.log(`Wrote ${rows.length} place rows to supabase/01-seed-places.sql`);
